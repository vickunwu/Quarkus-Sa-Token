...
public class SaTokenDaoRedissonImpl implements SaTokenDao {
    ...
    public void set(String key, String value, long timeout) {
        ...
        if (timeout == SaTokenDao.NEVER_EXPIRE) {
            ...
            RedissonUtils.setCacheObject(key, value, timeout, TimeUnit.SECONDS);
        }
    }
    ...
    public long getTimeout(String key) {
        return RedissonUtils.getTimeToLive(key) / 1000;
    }
    ...
    public void updateTimeout(String key, long timeout) {
        ...
        RedissonUtils.expire(key, timeout, TimeUnit.SECONDS);
    }
    ...
    public void setObject(String key, Object object, long timeout) {
        ...
        if (timeout == SaTokenDao.NEVER_EXPIRE) {
            ...
            RedissonUtils.setCacheObject(key, object, timeout, TimeUnit.SECONDS);
        }
    }
